...
import { fadeInVariants, buttonVariants } from "~/lib/animationVariants";
          ...
          <div className="py-16 px-6 bg-gray-50">
            ...
            {band.contact?.email && (
              <div className="mb-4">
                ...
                <a href={`mailto:${band.contact.email}`} className="text-blue-600 hover:underline text-lg">
                  {band.contact.email}
                </a>
              </div>
            )}
           ...
           {band.socialMedia && band.socialMedia.length > 0 && (
               <div className="mb-8">
                 <label className="block text-gray-700 font-semibold mb-4">Follow Us</label>
             ...
             <div className="border-t pt-6">
               <p className="text-gray-600">
                 For booking inquiries, please contact us via email or phone. We typically respond within 48 hours.
               </p>
             </div>
           </motion.div>
         </div>
